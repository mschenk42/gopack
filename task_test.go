...
func TestWhenRun(t *testing.T) {
	...
	t1.NotifyWhen(t2, action.Create, action.Create, false)
...
func TestDelayedRun(t *testing.T) {
	...
	t1.NotifyWhen(t2, action.Create, action.Create, true)
	t3.NotifyWhen(t2, action.Create, action.Create, true)
...
func TestDelayedChainedRun(t *testing.T) {
	...
	t2.NotifyWhen(t1, action.Create, action.Create, true)
	t3.NotifyWhen(t2, action.Create, action.Create, true)
...
func (t Task1) Run(runActions ...action.Enum) bool {
...
func (t Task2) Run(runActions ...action.Enum) bool {
	regActions := action.Methods{
