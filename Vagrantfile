...
grep -q -F 'cd /opt/gopath/src/github.com/mschenk42/gopack' /home/vagrant/.bashrc || cat >>/home/vagrant/.bashrc <<EOF

## After login, change to gopack directory
cd /opt/gopath/src/github.com/mschenk42/gopack
EOF
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder '.', '/opt/gopath/src/github.com/mschenk42/gopack'
